...
//#endregion
//#region node_modules/node-fetch/node_modules/tr46/lib/mappingTable.json
...
//#endregion
//#region node_modules/node-fetch/node_modules/tr46/index.js
...
var URL = Url.URL || import_public_api.URL;
...
//#endregion
//#region node_modules/@tonconnect/isomorphic-fetch/index.mjs
function fetch(url, options) {
	if (/^\/\//.test(url)) url = "https:" + url;
	return fetch$1.call(this, url, options);
}
if (!global.fetch) {
	global.fetch = fetch;
