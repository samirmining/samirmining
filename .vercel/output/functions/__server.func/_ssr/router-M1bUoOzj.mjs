...
import { N as webappUrl, _ as isMongoConfigured, h as isBotConfigured, m as getStore } from "./store-C4rWle75.mjs";
import { c as TriangleAlert } from "../_libs/lucide-react.mjs";
import { n as handleTelegramUpdate } from "./bot-BtTIOHt3.mjs";
import { a as union, i as string, n as number, r as object, t as literal } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-M1bUoOzj.js
var router_M1bUoOzj_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-MRHrvt92.css";
var APP_NAME = "ZX Miner";
var Route$6 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "ZX Telegram mini app — mine, complete tasks, invite friends, withdraw to TON."
			}
		],
		links: [
			{
...
var $$splitComponentImporter$2 = () => import("./routes-D51zrufN.mjs");
var Route$5 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./admin-Ckt0HfIM.mjs");
var Route$4 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./app-Bz6OoL2t.mjs");
var Route$3 = createFileRoute("/app")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var Route$2 = createFileRoute("/tonconnect-manifest.json")({ server: { handlers: { GET: async ({ request }) => {
	const origin = webappUrl() || new URL(request.url).origin;
	return Response.json(manifest(origin), { headers: {
...
var Route$1 = createFileRoute("/api/health")({ server: { handlers: { GET: async () => {
	...
	if (isBotConfigured() && webappUrl()) try {
...
var rootRouteChildren = {
	...
	AppRoute: Route$3.update({
		id: "/app",
		path: "/app",
		getParentRoute: () => Route$6
	}),
	TonconnectManifestDotjsonRoute: Route$2.update({
...
//#endregion
export { getRouter, router_M1bUoOzj_exports as t };
